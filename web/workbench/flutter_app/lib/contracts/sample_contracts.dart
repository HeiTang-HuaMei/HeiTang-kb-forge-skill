  ...
  jsonEncode({
    ...
    'actions': {
      'actions': [
        ...
        _action('extract_methodology', 'skill_factory', 'Extract Methodology', 'extract-methodology --kb <package> --out <output>', true),
        _action('skill_governance_report', 'skill_factory', 'Skill Governance Report', 'skill-governance-report', true),
    ...
    'assets': {
      'assets': [
        ...
        {'asset_id': 'skill_governance_report_json', 'asset_type': 'report', 'deterministic_fixture_path': 'fixtures/p2_2/skill_governance_report.json', 'page_id': 'skill_factory'},
        {'asset_id': 'methodology_map_json', 'asset_type': 'report', 'deterministic_fixture_path': 'fixtures/p2_2/methodology_map.json', 'page_id': 'skill_factory'},
    ...
    'reports': {
      'reports': [
        ...
        {'report_id': 'report_skill_governance', 'page_id': 'skill_factory', 'title': 'Skill Governance'},
        {'report_id': 'report_methodology_map', 'page_id': 'skill_factory', 'title': 'Methodology Map'},
