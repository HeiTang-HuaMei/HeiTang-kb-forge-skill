...
P1 现在是 local Workbench evidence gate，已通过 v4 RC readiness。项目已进入 `v4.0.0-rc.1` release candidate preparation；stable `v4.0.0` 仍需要 rc.1 acceptance 与 hardening evidence。
...
- 当前处于 `v4.0.0-rc.1` release candidate preparation；stable `v4.0.0` 尚未发布。
