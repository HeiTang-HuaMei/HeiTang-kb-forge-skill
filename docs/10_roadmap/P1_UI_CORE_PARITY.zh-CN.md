...
P1 是历史 local Workbench evidence gate，已通过 v4 RC readiness。项目已通过 `v4.0.0-rc.1` acceptance 与 hardening，进入 stable `v4.0.0`；当前 main 已推进到 v4.1.0 Parser/OCR release hardening，并保留该 P1 evidence。
...
- stable `v4.0.0` 是 rc.1 acceptance 与 hardening evidence 之后的历史 P1-backed release。
- 当前 `v4.1.0` 增加 P2.1 parser/OCR backend matrix evidence，不改变 P1 gate。
