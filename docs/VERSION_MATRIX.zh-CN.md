...
当前阶段：v4.0.0-rc.1 release candidate preparation。stable v4.0.0 等待 rc acceptance 与 hardening。
...
| v4.0.0-rc.1 | Current | Workbench UI release candidate，包含 P1 final gate evidence、external registry 可见边界与 S/A contract inclusion 可见边界 | pytest、Flutter tests/builds | 不是 stable v4.0.0；外部项目仍只做可见边界 | current |
| v4.0.0 | Future | Stable Local Knowledge Workbench release | pending rc acceptance and hardening | 尚未发布 | future |
