...
| UI | Core contracts, P1-RWF-V2 evidence, and UI consumption proof exist. The P1 final gate re-run, External Project Registry, S/A Contract Inclusion, and rc.1 hardening are complete. | stable v4.0.0 |
