...
| UI | Core contracts、P1-RWF-V2 evidence 和 UI consumption proof 已存在。P1 final gate re-run、External Project Registry、S/A Contract Inclusion 与 rc.1 hardening 已完成。 | stable v4.0.0 |
