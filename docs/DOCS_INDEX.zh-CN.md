...
- [验证门禁 Manifest](testing/VALIDATION_GATE_MANIFEST.json)
- [测试瘦身登记表](testing/TEST_PRUNING_REGISTER.zh-CN.md)
...
- [S/A 外部项目合同加入](roadmap/external_projects/S_A_CONTRACT_INCLUSION.zh-CN.md)
- [外部项目加入政策](roadmap/external_projects/EXTERNAL_PROJECT_INCLUSION_POLICY.zh-CN.md)
