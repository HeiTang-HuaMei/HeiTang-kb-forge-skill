...
- P0 final_pre_v4_gate_still_blocked: fixed - Final gate now has local full pytest and CI-green evidence attached. It remains blocked only because the real architecture P0 `rag_vector_index_industrial_readiness_unproven` is unresolved.
