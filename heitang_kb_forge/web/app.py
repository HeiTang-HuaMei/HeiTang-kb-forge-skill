...
def load_package_summary(package: Path) -> dict:
    ...
    for report_name in [
        ...
        "golden_sample_validation_report.md",
        "platform_export_certification_report.md",
        "compatibility_matrix.md",
        "llm_quality_gate_assist_report.md",
...
def render_app() -> None:
    ...
    for title, key in [
        ...
        ("Quality Gate", "quality_gate_report.md"),
        ("Release Blockers", "release_blockers.md"),
        ("Regression", "regression_report.md"),
        ("Golden Samples", "golden_sample_validation_report.md"),
        ("Export Certification", "platform_export_certification_report.md"),
        ("Compatibility Matrix", "compatibility_matrix.md"),
        ("LLM Quality Assist", "llm_quality_gate_assist_report.md"),
