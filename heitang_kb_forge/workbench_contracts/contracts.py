...
def generate_workbench_contracts(core_output: Path, output: Path | None = None, project_name: str = "HeiTang Workbench") -> dict:
    ...
    actions = {
        ...
        "actions": [
            ...
            {"id": "build_skill_suite", "label": "Build Skill Suite", "command": "build-skill-suite", "requires": ["skill_plan", "output"]},
            {"id": "export_skill_pack", "label": "Export Skill Pack", "command": "export-skill-pack", "requires": ["skill_suite", "output"]},
            {"id": "validate_skill_suite", "label": "Validate Skill Suite", "command": "validate-skill-suite", "requires": ["skill_suite"]},
            {"id": "diff_skill_suite", "label": "Diff Skill Suite", "command": "diff-skill-suite", "requires": ["before_suite", "after_suite", "output"]},
            {"id": "check_skill_suite_installability", "label": "Check Skill Suite Installability", "command": "check-skill-suite-installability", "requires": ["skill_suite"]},
            {"id": "skill_suite_governance_report", "label": "Skill Suite Governance Report", "command": "skill-suite-governance-report", "requires": ["skill_suite"]},
    ...
    status = {
        ...
        "skill_suite_available": (core_output / "suite.json").exists(),
        "skill_pack_available": (core_output / "skill_pack_manifest.json").exists(),
        "skill_suite_validation_available": (core_output / "suite_validation_report.json").exists(),
        "skill_suite_diff_available": (core_output / "skill_suite_diff_report.json").exists(),
        "skill_suite_installability_available": (core_output / "skill_suite_installability_report.json").exists(),
        "skill_suite_governance_available": (core_output / "skill_suite_governance_report.json").exists(),
    }
    manifest = {
...
def _assets(core_output: Path) -> list[dict]:
    candidates = [
        ...
        ("suite.json", "skill_package"),
        ("SKILL_HIERARCHY.json", "report"),
        ("DEPENDENCY_GRAPH.json", "report"),
        ("hierarchy_analysis.json", "report"),
        ("SKILL_INDEX.md", "report"),
        ("ROUTING.md", "report"),
        ("METHODOLOGY_MAP.md", "report"),
        ("SOURCE_TRACE.md", "report"),
        ("skill_pack_manifest.json", "skill_package"),
        ("description_trigger_quality_report.json", "report"),
        ("allowed_files_boundary_report.json", "report"),
        ("skill_eval_checklist.md", "report"),
        ("skill_optimization_notes.md", "report"),
        ("PACK_README.md", "report"),
        ("suite_validation_report.json", "report"),
        ("VALIDATION_REPORT.md", "report"),
        ("skill_suite_diff_report.json", "report"),
        ("DIFF_REPORT.md", "report"),
        ("skill_suite_installability_report.json", "report"),
        ("INSTALLABILITY_REPORT.md", "report"),
        ("skill_suite_governance_report.json", "report"),
        ("GOVERNANCE_REPORT.md", "report"),
