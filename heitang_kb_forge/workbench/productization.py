...
_ACTION_SEED = [
    ...
    ("import_parsing", "ocr_required_detection", "Detect OCR requirement", "ready", "full-ocr-acceptance --core-repo <repo> --output <output>", ["report_ocr_required_detection"], ["artifact_ocr_review_queue"], ["ocr_failed"]),
    ...
    ("knowledge_package_management", "package_export", "Export downstream package", "ready", "export-platform --package <package> --output <output>", ["report_downstream_export"], ["artifact_downstream_package"], ["artifact_missing"]),
