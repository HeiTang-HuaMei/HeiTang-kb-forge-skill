...
状态：在 P1 Final Gate、External Project Registry、S/A Contract Inclusion 之后，进入 v4.0.0-rc.1 release candidate preparation。
...
- `ready_for_v4_rc=true`；`v4.0.0-rc.1` 是 release candidate，不是 stable `v4.0.0` release。
...
- P1 local Workbench gate 已可进入 v4 RC preparation，本分支现在准备 `v4.0.0-rc.1`。
- stable `v4.0.0` 必须在 rc.1 acceptance 与 hardening evidence 通过后才发布。
