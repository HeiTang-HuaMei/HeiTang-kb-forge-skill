...
EXPECTED_STATUS = {
    ...
    "seedance2_skill": ["needs_verification", "future_adapter"],
    "ai_marketing_skills": ["template_reference"],
    "rtk": ["benchmark_only", "needs_verification"],
    ...
    "surya": ["planned_adapter", "needs_verification"],
    "unstructured": ["planned_adapter", "needs_verification"],
