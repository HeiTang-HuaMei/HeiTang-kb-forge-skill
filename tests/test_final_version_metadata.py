...
def test_version_matrix_is_chronological_and_marks_v4_future():
    ...
    assert "| v4.0 | Local Knowledge Workbench RC |" in text
    assert "| v4.0 | Local Knowledge Workbench RC |" in text and "| v4.0 |" in text and "| future | no |" in text
