...
def test_version_matrix_covers_release_history_and_planned_versions():
    ...
    for version in ["v0.1", "v1.6", "v1.7", "v1.8", "v1.9", "v2.0", "v2.1", "v2.2", "v2.3", "v2.3.1-dev", "v2.4", "v2.4.1-dev", "v2.5.0-dev", "v2.5.1-alpha.1", "v2.6.0-alpha.1", "v2.7.0-alpha.1", "v2.8.0-alpha.1", "v2.9.0-alpha.1", "v3.12.0-alpha.1", "final-pre-v4.0", "v4.0.0-rc.1", "v4.0.0", "v4.1.0", "v4.1.1", "v4.2.0"]:
    ...
    assert "| v4.2.0 | P2.2 Knowledge-to-Methodology-to-Skill-Suite Industrial Baseline |" in text
