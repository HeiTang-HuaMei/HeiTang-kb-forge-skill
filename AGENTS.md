...
- Campaigns 4-9 are governed by `CAMPAIGN_4_9_REPLACEMENT_PLAN.md`: Campaign 4 Goal-Oriented Product UI Workbench, Campaign 5 Chain-Level Local Core Bridge, Campaign 6 Agent Foundation, Campaign 7 Configuration System Engineering, Campaign 8 Full Testing / Full Review, and Campaign 9 EXE Packaging. Do not enter any of them before Supplement 4.0, Campaign 3 Final Consistency Gate, Campaign 1-3 Stage Test Gate, Integrated Closure Gate, Closure Pack generation, Repository Public Surface Cleanup / Rename / Push-Tag Safety Gate, repository push, baseline tag, CI/CL green, and Closure Checklist green all pass. Campaign 6 also requires Campaign 4 Page-Level UI Redesign owner visual acceptance and Campaign 4+5 UI-Bridge Realignment Gate acceptance before its Entry Gate may open.
